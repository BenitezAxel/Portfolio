        ...
        <div class="container">
            <div class="row mt-5">
                <div class="col-sm-7 col-12">
                    <h1>Sobre mi</h1>
                    <h2>Apasionado por la tecnología y gestión de proyectos. Soy una persona en constante movimiento esforzandome y aprendiendo 
                    sobre nuevas tecnologías, para ofrecer un mejor rendimiento en las diferentes tareas que se me presenten.</h2>
            ...
            <div class="row my-sm-4 my-3">
                ...
                <div class="col-sm-6 col-12 px-2 my-2">
                    <div class="bg-white">
                        ...
                        <div class="row p-3">
                            <div class="col-12">
                                <p>Escuchar musica, Armado de PC.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container py-sm-5 py-4">
            ...
            <div class="row py-2">
                <div class="col-12 col-sm-2">
                    <h3>2019 - 2020 -<br> La Rambla</h3>
                </div>
                <div class="col-12 col-sm-2">
                    <img src="images/rambla.jpg" alt="La Rambla" class="img-responsive py-3 py-sm-0" width="120" title="La Rambla">
                </div>
                <div class="col-12 col-sm-8">
                    <h4>"Realice todo tipo de tareas relacionadas a la gastronomia, como limpieza del
